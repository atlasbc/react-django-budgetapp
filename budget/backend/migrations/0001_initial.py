# Generated by Django 3.1.5 on 2021-02-15 12:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Grocery', 'Grocery'), ('Bills & Utilities', 'Bills & Utilities'), ('Entertainment', 'Entertainment'), ('Other', 'Other')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('amount', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('category', models.CharField(choices=[('Salary', 'Salary'), ('Bonus', 'Bonus'), ('Side', 'Side'), ('Other', 'Other')], max_length=100)),
